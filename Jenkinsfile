pipeline {
	...
	nexusArtifactUploader artifacts: [[artifactId: 'hello-world-testing', classifier: '', file: 'target/hello-world-testing-3.0.0.jar', type: 'jar']], credentialsId: 'nexus-demo', groupId: 'devops', nexusUrl: 'http://44.192.22.223:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'DevopsDemo', version: '3.0.0'
